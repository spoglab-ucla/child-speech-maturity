...
def return_custom_train():
    transformed_dataset = AudioArrays(csv_file='PATH_TO_TRAIN_CSV',
                                           root_dir='PATH_TRAIN_AUDIO_CLIPS_FOLDER')

    return transformed_dataset

def return_custom_test():
    transformed_dataset = AudioArrays(csv_file='PATH_TO_TEST_CSV',
                                           root_dir='PATH_TEST_AUDIO_CLIPS_FOLDER')
...
def train_model(train_dataset, test_dataset):
    ...
    output_dir="MODEL_CHECKPOINTS_DESTINATION",
